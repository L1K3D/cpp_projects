// Exemplo_aplicavel_pilha.cpp : Este arquivo contém a função 'main'. A execução do programa começa e termina ali.
//
...
int main()
{
    //Cria uma pilha com itens do tipo string, essa lista se chama 'cartas'
    stack < string > cartas;
    ...
    //Exibe o último item a ter sido adicionado na pilha, o item do topo da pilha, nesse exemplo, a carta "Mago Negro"
    ...
    //Exibe o novo tamanho da pilha ocupado na mamória e exibe a quantidade de itens presentes na pilha
    cout << "Tamanho da pilha: " << cartas.size() << "\n";

    //Exibe agora o novo "ultimo item" da pilha após a remoção da carta "Mago Negro" que até o comando de 'pop' era o item do mais topo da pilha construida;
    cout << "Carta do topo: " << cartas.top() << "\n";
